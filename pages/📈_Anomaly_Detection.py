...
st.set_page_config(
    page_title="Anomaly Detection in Bearings",
...
st.title("Anomaly Detection in Bearings")
...
if st.button('Predict'):
    ...
    if prediction == 1:
        st.error("Please do take the necessary action as this is an Anomaly")
    else:
        st.success("The Bearings are working properly")
